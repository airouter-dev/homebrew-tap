class OaiSmoke < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/airouter-dev/openai-compatible-api-smoke-test/releases/download/v0.1.2/oai-smoke_0.1.2_darwin_arm64.tar.gz"
      sha256 "746b25e92922f9b0580b0f3581e51f8d6124afd794a4d44f38bf527c6259f98c"
    end
    on_intel do
      url "https://github.com/airouter-dev/openai-compatible-api-smoke-test/releases/download/v0.1.2/oai-smoke_0.1.2_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/airouter-dev/openai-compatible-api-smoke-test/releases/download/v0.1.2/oai-smoke_0.1.2_linux_arm64.tar.gz"
      sha256 "6a0b70aa3a7f04469b6e9dcced4f7eb4b3571e883aaa1843ee0423f80082d4bc"
    end
    on_intel do
      url "https://github.com/airouter-dev/openai-compatible-api-smoke-test/releases/download/v0.1.2/oai-smoke_0.1.2_linux_amd64.tar.gz"
